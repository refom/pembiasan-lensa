...
class Benda:
	...
	def draw(cls):
		...
		"""
		if x >= kt_x:
			x_new, y_new = persamaan((kt_x, y), (0, y), width) # 1
			pygame.draw.line(SCREEN, GREEN, (kt_x, y), (x_new, y_new))
		else:
			x_new, y_new = persamaan((kt_x, y), (0, y), 0) # 1
			pygame.draw.line(SCREEN, GREEN, (kt_x, y), (x_new, y_new))
...
class Bayangan:
	...
	def draw(cls):
		...
		if x <= kt_x:
			x_new, y_new = persamaan((kt_x, y), (0, y), 0) # 1
			pygame.draw.line(SCREEN, DEEPPINK, (kt_x, y), (x_new, y_new))
		else:
			x_new, y_new = persamaan((kt_x, y), (0, y), width) # 1
			pygame.draw.line(SCREEN, DEEPPINK, (kt_x, y), (x_new, y_new))
